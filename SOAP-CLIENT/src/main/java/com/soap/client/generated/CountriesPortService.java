 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://countries", wsdlLocation = "file:/C:/Users/Utente/Documents/SoapTest/SOAP-CLIENT/src/main/resources/country/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://countries", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Utente/Documents/SoapTest/SOAP-CLIENT/src/main/resources/country/countries.wsdl");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://countries", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://countries", "CountriesPortSoap11"), CountriesPort.class, features);
    }
